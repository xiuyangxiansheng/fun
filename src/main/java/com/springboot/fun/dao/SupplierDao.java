...
public interface SupplierDao {
     ...
     * */
    //获取所有商家
    List<NideShopSupplier> findAllSupplier( Map<String,Object> supplierMap);
    //上传商家
    ...
    //根据商家名字模糊搜索
    List<NideShopSupplier> findAllSupplierByName(String name);
    //根据商家id查询商家的收银员
    List<SupplierEmployeeEntity> findAllSupplierEmployeeBySupplierId(String supplierId);
    //添加收银员
    ...
    List<SupplierEmployeeEntity> findSupplierEmployeeByName(String name);
    //删除员工
